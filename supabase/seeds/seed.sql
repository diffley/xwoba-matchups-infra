...
INSERT INTO public.player_splits (
  ...
  -- Max Scherzer vs LHB (2024)
  (
    660670, 2024, 'pitcher', 'L', 'Max Scherzer',
    120,      NULL,    NULL,  NULL,  NULL, 0.280, 0.240, NULL, NULL, NULL, NULL, NULL,
    5,    0.0417, 0.3500,  88.0, 100.0,
    10.00, 0.3000, 0.2000, 0.5000,
    NOW() - INTERVAL '1 day'
  ),
  -- Max Scherzer vs RHB (2024)
  (
    660670, 2024, 'pitcher', 'R', 'Max Scherzer',
    380,      NULL,    NULL,  NULL,  NULL, 0.300, 0.270, NULL, NULL, NULL, NULL, NULL,
    15,   0.0395, 0.3800,  89.0, 102.0,
    11.00, 0.3200, 0.2100, 0.5400,
    NOW() - INTERVAL '1 day'
  );
